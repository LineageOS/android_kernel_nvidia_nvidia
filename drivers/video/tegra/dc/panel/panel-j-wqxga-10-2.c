/*
 * panel-j-wqxga-10-2.c: Panel driver for j-wqxga-10-2 panel.
 *
...
static int dsi_j_wqxga_10_2_enable(struct device *dev)
{
	return 0;
}


static int dsi_j_wqxga_10_2_postpoweron(struct device *dev)
{
	int err = 0;
	...
	err = tegra_panel_gpio_get_dt("j,wqxga-10-2", &panel_of);
	if (err < 0) {
...
static int dsi_j_wqxga_10_2_disable(struct device *dev)
{
...
static int dsi_j_wqxga_10_2_postsuspend(void)
{
	pr_info("dsi_j_wqxga_10_2_postsuspend\n");
	return 0;
}

struct tegra_panel_ops dsi_j_wqxga_10_2_ops = {
	.enable = dsi_j_wqxga_10_2_enable,
	.disable = dsi_j_wqxga_10_2_disable,
	.postpoweron = dsi_j_wqxga_10_2_postpoweron,
	.postsuspend = dsi_j_wqxga_10_2_postsuspend,
};
